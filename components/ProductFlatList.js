...
function ProductFlatList({ item, prp }) {
    ...
    return (
        ...
        <View key={item.id} style={{ minHeight: 65, width: 140, margin:15,
            ...
            <TouchableOpacity onPress={() => { prp.navigation.navigate("DetailsProduct", { id: item.id, documnetKind: 3 }) }} style={{ flexDirection: "row", justifyContent: "center", flex: 2, alignItems: "center", backgroundColor: "#d8672b" }}>
