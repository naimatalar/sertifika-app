          ...
          <View
            ...
            //  console.log(dimgN)
              return (
                ...
                <View key={key} style={{minHeight:65, flexDirection: "row", flex: 5, marginBottom: 10, backgroundColor: "white",borderTopWidth:1,borderBottomWidth:1,borderColor:"#d8672b",borderWidth:1 }}> 
